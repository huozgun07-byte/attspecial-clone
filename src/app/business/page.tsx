        ...
        <section className="py-16 bg-white" aria-labelledby="services-title">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8" role="list">
              {[
                { title: "Business Fiber", desc: "Dedicated fiber internet up to 5 GIGs with 99.9% uptime SLA", icon: "🌐" },
                { title: "Wireless Plans", desc: "Unlimited data, mobile hotspot, and 5G access for your team", icon: "📱" },
                { title: "Security & IoT", desc: "Cybersecurity solutions, managed Wi-Fi, and IoT connectivity", icon: "🔒" },
              ].map((service, i) => (
