    ...
    <footer className="bg-att-gray-50 border-t border-att-gray-200" role="contentinfo">
      <div className="att-container py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h4 className="font-semibold text-att-gray-900 mb-4">Connect</h4>
            <p className="text-sm text-att-gray-600">© 2026 AT&T Intellectual Property. All rights reserved.</p>
          </div>
        </div>
        <div className="pt-8 border-t border-att-gray-200 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-att-gray-500">
